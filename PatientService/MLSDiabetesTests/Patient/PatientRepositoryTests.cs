...
namespace PatientRepositoryTests
{
    public class PatientRepositoryTests
    {
        ...
        // Méthode utilitaire pour créer une fabrique de DbContext qui retourne un nouveau contexte InMemory
        ...
        public async Task AddPatient_ShouldAddPatientToDatabase()
        {
            ...
            // Dans l'InMemory DB, EF Core ne gère pas forcément l'auto-incrémentation comme SQL Server,
            // mais on peut vérifier que le patient est présent en récupérant la liste des patients.
